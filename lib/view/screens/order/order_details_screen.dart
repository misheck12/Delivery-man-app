        ...
        body: SafeArea(
          child: Padding(
            ...
            child: GetBuilder<OrderController>(builder: (orderController) {
              ...
              bool? parcel, processing, accepted, confirmed, handover, pickedUp, cod, wallet, partialPay;
                  ...
                  child: Column(children: [
                    ...
                    Row(children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          cod! ? 'cod'.tr : wallet! ? 'wallet'.tr : partialPay! ? 'partially_pay'.tr : 'digitally_paid'.tr,
                    ...
                    partialPay! ? DottedBorder(
                      ...
                      child: Ink(
                        ...
                        child: Column(children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('${'due_amount'.tr} (${order.payments![1].paymentMethod?.tr})', style: !restConfModel ? robotoMedium : robotoRegular),
                            Text(
